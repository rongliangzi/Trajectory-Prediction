...
if __name__ == '__main__':
    ...
    dataFile = 'D:/Dev/TrajPred/Segmented_reference_path_DR_USA_Roundabout_FT.mat'
    ...
    # pickle_file = open('D:/Dev/TrajPred/pickle/FT/ref_path_xy_FT.pkl', 'wb')
    ...
    # pickle_file = open('D:/Dev/TrajPred/pickle/FT/ref_path_frenet_FT.pkl', 'wb')
    # pickle.dump(ref_point_frenet, pickle_file)
    # pickle_file.close()
    # FT_interactions = find_all_interactions(FT_ref_path_points, k=insert_k)
    # pickle_file = open('D:/Dev/TrajPred/pickle/FT/interaction_FT.pkl', 'wb')
    # pickle.dump(FT_interactions, pickle_file)
    # pickle_file.close()
    # save_interaction_bg_figs(FT_ref_path_points, FT_interactions, map_dir+map_name,
    #                          'D:/Dev/TrajPred/intersection_figs/roundabout_FT/')

    img_save_dir = 'D:/Dev/TrajPred/intersection_figs/high-res_roundabout_FT_crop/'
    rotate_n = 0
    # crop_interaction_figs(FT_ref_path_points, FT_interactions, ref_point_frenet, img_save_dir, rotate_n)
    # save_complete_ref_path_fig(FT_ref_path_points, 'D:/Dev/TrajPred/intersection_figs/single_FT/',
    #                            (945, 1070), (945, 1050))

    # if not os.path.exists('D:/Dev/TrajPred/pickle/FT/track_path_frenet_FT.pkl'):
    #     pickle_file = open('D:/Dev/TrajPred/pickle/FT/track_path_frenet_FT.pkl', 'rb')
    ...
    #     pickle_file = open('D:/Dev/TrajPred/pickle/FT/track_path_frenet_FT.pkl', 'wb')
    #     pickle.dump(csv_data, pickle_file)
    #     pickle_file.close()
    # save_ts_theta(csv_data, 'D:/Dev/TrajPred/pickle/FT/ts_theta_FT.pkl')
    # for k, v in csv_data.items():
    #     print(k)
    #     split_edges = get_csv_edges(v, FT_interactions, ref_point_frenet, k,
    #                                 img_save_dir+k+'/', FT_ref_path_points)
    #     pickle_file = open('D:/Dev/TrajPred/pickle/FT/edges_FT_{}.pkl'.format(k), 'wb')
