...
if __name__ == '__main__':
    ...
    plot_ref_path(map_path, EPT_ref_path_points)
    ...
    # pickle_file = open('D:/Dev/TrajPred/pickle/EPT/ref_path_xy_EPT.pkl', 'wb')
    # pickle.dump(EPT_ref_path_points, pickle_file)
    # pickle_file.close()

    # ref_point_frenet = ref_paths2frenet(EPT_ref_path_points)
    # pickle_file = open('D:/Dev/TrajPred/pickle/EPT/ref_path_frenet_EPT.pkl', 'wb')
    ...
    # pickle_file = open('D:/Dev/TrajPred/pickle/EPT/interaction_EPT.pkl', 'wb')
    ...
    # csv_data = get_track_label('D:/Dev/TrajPred/Roundabout_EP_final/track_T/',
    #                            EPT_ref_path_points, ref_point_frenet)
    # pickle_file = open('D:/Dev/TrajPred/pickle/EPT/track_path_frenet_EPT.pkl', 'wb')
    # pickle.dump(csv_data, pickle_file)
    # pickle_file.close()
    # save_ts_theta(csv_data, 'D:/Dev/TrajPred/pickle/EPT/ts_theta_EPT.pkl')
    # # save edge info
    # for k, v in csv_data.items():
    #     print(k)
    #     split_edges = get_csv_edges(v, EPT_interactions, ref_point_frenet, k,
    #                                 img_save_dir + k + '/', EPT_ref_path_points)
    #     pickle_file = open('D:/Dev/TrajPred/pickle/EPT/edges_EPT_{}.pkl'.format(k), 'wb')
